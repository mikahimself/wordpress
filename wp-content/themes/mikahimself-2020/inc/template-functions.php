 ...
 * @return array
 */
function mikahimself_2020_body_classes( $classes ) {
...
add_filter( 'body_class', 'mikahimself_2020_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function mikahimself_2020_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'mikahimself_2020_pingback_header' );

function mikahimself_2020_footer_content() {
...
add_action( 'wp_footer', 'mikahimself_2020_footer_content');